...
//Definition de la fonction qui permet de tirer une carte aléatoirement
...
//Definition de la fonction qui permet de donner un score aléatoire à la banque entre 16 et 21 
    int score_banque() 
       {
        int i,carte_tiree;
        srand ( time( NULL ) );
...
//Definition de la fonction qui affiche les cartes selon leurs valeurs
...
//cas particulier : valeur de l'As
...
//Definition des valeurs des valets dames et rois
...
//distribution de la premiere carte
      
      carte_tiree=tirrer_carte();
...
//proposer de continuer a jouer
                  if(somme_des_carte_joueur<21)
                    ...
                    {
                    printf("\n\n\n##############      ");
                    printf("VOUS AVEZ PERDUE LA PARTIE");
...
//Score de la machine et Affichage du resultat
if(temoin_auto_defete==0)
{
somme_des_carte_adversaire=score_banque();
