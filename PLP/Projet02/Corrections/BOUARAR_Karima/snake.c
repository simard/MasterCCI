...
int main (int argc , char** argv){
	...
	while(somme_blocage != nbserpents){      /* teste si tout les serpents sont bloqu̩s ou pas */
...
/*serpent placement_serpents(unsigned int colonne , unsigned int ligne){
	...
	switch(dir)
	{
	case 0 : srpt.sens=haut; 
	break;
	case 1 : srpt.sens=bas; 
	break;
	case 2 : srpt.sens=droite;
	break;
	case 3 : srpt.sens=gauche;
	break;
	}
	return srpt;
	}*/
