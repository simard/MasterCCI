...
/* Declaration des bibliotheques de travail */
...
int main (int argc , char** argv){
	...
	if (argc !=4)  /* teste si le nombre d'arguments est egale a celui specifie pour snake */
	{
	...
	while(somme_blocage != nbserpents){      /* teste si tout les serpents sont bloques ou pas */
	...
	return 0;
}                     /* fin du corps principal de programme */
