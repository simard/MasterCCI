 ...
 struct adresse
    ...
    struct adresse var_adresse[100], 
      ...
      /*  Exercice 2 : affichage d'un menu   */
	...
	{
		case 1:
			nouveau_contact (Liste * liste, char *donnee );  // pour creer un nouveau contact 
			break;
		case 2:
			Liberer_liste (Liste * liste();             // pour liberer l'espace memoire 
			break;
		case 3:
			affiche (Liste * liste)();                 // fonction qui affiche tous les contacts 
			break;
		case 4:
			enregestrement ();                     //  fonction qui enregestre le nom, prenom et email dans un fichier 
			break;
		case 5:
		   charger () ;                          // Charger un carnet d'adresse 
            break;
      case 6 : supprimer (int j ) ;                // pour Supprimer un contact 
           break;
       case 7: modifier() ;                       // pour modifier un contact 
            break;
            }
            
        
        /*  Exercice 3 : création d'un contact   */
...
return 0;
                           ...
                           /* Exercice 04  Liberer l'espace mémoire    */
...
int Liberer_liste (Liste * liste){
  ...
  return 0;
                                      ...
                                      /*   Exercice 05  Afficher les contacts   */
  ...
  while (courant != NULL){
      ...
      courant = courant->suivant;
                         ...
                         /* Exercice 06  : Enregistrer le carnet d'adresse dans un fichier   */ 
                         void enregestrement ()
                         {
                         ...
                         // cette fonction "FPUTS" ecrit une chaine dans un fichier et retourne une valeur positive ou, EOF s'il ya eu une erreur 
                        ...
                        while (Nbcontacts !=0  )  
                         ...
                         printf ("\n " );   //  un espace entre les contacts 
                         {
                                {
                         
                         /* Exercice 07 :  Charger un carnet d'adresse  */
...
{	
	...
	{	case 1:
		{
			while (!feof(fichier))   // tester la fin de fichier 
...
// Exercice 08 :  supprission  d'un contact  
...
//  j'ai utiliser la structure déclarée dans le 1er exercice avec la variable  "var_adresse[i].nom" 
...
printf ("entrer le nombre de contacts dans ce carnet  %d :" Nbdecontacts ) .
	...
	{	case 1:        
     ...
     gets (var_adresse[i].nom);                           // la fonction gets = scanf 
     }
     }
        i++
     ...
     gets (var_adresse[j].prenom);                           // la fonction gets = scanf 
     }
     }
        j++
     ...
     gets (var_adresse[k].email);                           // la fonction gets = scanf 
     }
     }
        k++
